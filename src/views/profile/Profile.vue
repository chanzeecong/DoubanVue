<template>
  <div class="user-center">
    <div class="user">
      <div class="avatar">
        <img src="./timg.jpg" alt="" width="60" height="60">
      </div>
    ...
    <scroll class="switch-item" :data="itemLists" ref="scroll">
      <div class="user-item" v-for="(item,index) in switches" v-if="index === currentIndex">
        ...
        <rank-list :rank-items="itemLists"
                   :need-rank="needRank"
...
<script>
  ...
  import CelebrityList from "../celebrity-list/celebrity-list";
  export default {
    name: "Profile",
    components: {CelebrityList, RankList, Scroll, Switches},
    data() {
      return {
        currentIndex: 0,
        needLoading: false,
