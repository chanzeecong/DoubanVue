    ...
    <div class="list-wrapper">
      ...
      >
        <div class="list-inner">
          <move-list :movies="hotMovies" :hasMore="hasMoreHotMovies" @select="selectMovie"></move-list>
        </div>
      </scroll>
...
<script>
  ...
  import {getMovie, getComingMovie} from "network/move-show";
  ...
  export default {
    name: "Move-show",
    components: {Loadmore, MoveList, Scroll, Switches},
    data() {
      return {
        currentIndex: 0,
        switches: [
