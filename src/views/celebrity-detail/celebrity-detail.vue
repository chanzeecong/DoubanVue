<template>
  <div class="detail-wrapper">
      ...
      <div class="scroll-wrapper">
        ...
        <div class="celebrity-info">
          <div class="main">
            ...
            <div class="collect" :class="{'has-collected': isCollected}" @click="saveCollect">
          ...
          <scroll class="works" :scrollX="this.scrollX" :eventPassthrough="this.eventPassthrough" ref="scroll" v-if="works.length">
            <div class="works-content" ref="content">
              ...
              <div class="works-item" v-for="item in works" @click="selectWork(item,$event)">
                <img v-lazy="replaceUrl(item.image)" width="90" height="120" alt="代表作品">
    ...
    <loadmore :full-screen="fullScreen" v-if="!celebrityDetail.avatars"></loadmore>
    <celebrity-info :info-lists="celebrityDetail" ref="info"></celebrity-info>
...
<script>
  ...
  import CelebrityInfo from "../celebrity-info/celebrity-info";
  import {createMovieList} from '../../components/common/js/moveList'
  import  Celebrity  from 'components/common/js/celebrity'
  import { getCelebrity } from "network/celebrity";
  import { mapGetters,mapMutations, mapActions } from 'vuex'
  export default {
    name: "celebrity",
    components: {Loadmore, CelebrityInfo, Star, Scroll},
    data() {
      return {
        celebrityDetail:{},
        works: [],
