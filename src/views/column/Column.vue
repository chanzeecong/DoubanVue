...
<template>
  <div class="rank">
    <div class="go-search" @click="goSearch">
      <div class="logo">
        <img src="~assets/img/douban-logo.jpg" width="35" height="35">
      </div>
    ...
    <scroll class="rank-list" :data="urlList" ref="scroll">
      <div class="scroll-wrapper">
        <div class="scroll-content" v-if="hasLoad">
          ...
          <router-link tag="div" to="/column/top250" class="top250 rank-item">
            <div class="desc">
          ...
          <router-link tag="div" to="/column/weekly" class="weekly rank-item">
            <div class="desc">
          ...
          <router-link tag="div" to="/column/new-movie" class="new-movie rank-item">
            <div class="desc">
          ...
          <router-link tag="div" to="/column/us-box" class="us-box rank-item">
            <div class="desc">
...
<script>
  ...
  import WeekDate from "components/common/js/date"
  import { top250Rank, usBoxRank, weeklyRank, newMoviesRank } from '../../network/movie-rank.js';
