...
import { saveSearch, deleteSearch, clearSearch, saveComment, saveWantedMovie, saveWatchedMovie, saveCelebrity } from '../components/common/js/cache';

export const saveSearchHistory = function ({commit}, query) {
  commit(types.SET_SEARCH_HISTORY, (saveSearchquery));
};
